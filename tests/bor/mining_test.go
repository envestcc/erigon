...
import (
	...
	"github.com/ledgerwatch/erigon/v2/tests/bor/helper"
...
// Example : CGO_CFLAGS="-D__BLST_PORTABLE__" go test -run ^TestMiningBenchmark$ github.com/ledgerwatch/erigon/v2/tests/bor -v -count=1
